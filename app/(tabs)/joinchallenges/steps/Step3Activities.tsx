...
const activityGradients: { [key: string]: [string, string] } = {
  ...
  Yoga: ['#9C27B0', '#4A148C'],
  Count: ['#607D8B', '#263238'],
  Walking: ['#8BC34A', '#33691E'],
  Running: ['#FFC107', '#FF6F00'],
  Cycling: ['#2196F3', '#0D47A1'],
  Swimming: ['#03A9F4', '#01579B'],
  Hiking: ['#689F38', '#33691E'],
  'Sleep Quality': ['#00BCD4', '#006064'],
  Meditation: ['#9C27B0', '#4A148C'],
  'Weight Training': ['#F44336', '#B71C1C'],
  'Cardio Workout': ['#F44336', '#B71C1C'],
  'High-Intensity': ['#F44336', '#B71C1C'],
  Stretching: ['#9C27B0', '#4A148C'],
  'Bonus Points': ['#FFC107', '#FF6F00'],
