...
const styles = StyleSheet.create({
  ...
  addCustomActivityCard: { borderRadius: 12, marginVertical: 8, overflow: 'hidden', borderWidth: 2, borderColor: '#00000', borderStyle: 'dashed' },
  addCustomGradient: { padding: 16, alignItems: 'center', justifyContent: 'center', flexDirection: 'row' },
  addCustomActivityText: { color: '#00000', fontSize: 16, fontWeight: '600', marginLeft: 8 },
  ...
  modalAddButton: { backgroundColor: '#00000', borderRadius: 8, paddingVertical: 10, paddingHorizontal: 16 },
  ...
  reviewIcon: { width: 42, height: 42, borderRadius: 21, backgroundColor: '#00000', alignItems: 'center', justifyContent: 'center', marginRight: 16 },
  ...
  activityIconCircle: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#00000', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
